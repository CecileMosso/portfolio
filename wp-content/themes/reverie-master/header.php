...
<body <?php body_class('antialiased'); ?>>
	<header class="contain-to-grid">
		...
		<div class="fixed" style="background: #F00;">
...
<div class="full-width">
	<img src="<?= get_template_directory_uri(); ?>/img/temp-home-slider.jpg" style="min-width: 100%;" />
</div>
<div class="full-width">
	<div class="row">
		<p>Aide et action.... bla bla</p>
	</div>
</div>
...
<div class="container" role="document">
	...
	<div class="row">
		<?php $teest = file_get_contents('http://api.storify.com/v1/stories/jefffairson');
				echo "<pre>";
				var_dump(json_decode($teest));
				echo "</pre>";